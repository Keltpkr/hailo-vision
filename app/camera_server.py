...
HEIGHT = int(os.getenv("CAMERA_HEIGHT", "1440"))
FPS = int(os.getenv("CAMERA_FPS", "5"))
USE_SUDO = os.getenv("CAMERA_USE_SUDO", "1") == "1"
RESOLUTIONS = ("640x480", "1280x720", "1920x1080", "1920x1440")
...
app = FastAPI(title="Hailo Camera Viewer", version="1.6.0")
        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                for face in faces:
                    ...
                    if person is None and len(detections) == 1:
...
const resolutions = ["640x480", "1280x720", "1920x1080", "1920x1440"];
